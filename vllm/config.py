...
class SpeculativeConfig:
    ...
    def maybe_create_spec_config(
        ...
        Args:
            ...
            backend_device (Optional[str]): Select backend on CPU, such as OpenVino, Pyotrch
    ...
    def __init__(
        ...
        Args:
            ...
            backend_device (Optional[str]): Select backend on CPU, such as OpenVino, CPU(default Pyotrch)
        """
